	...
	<div class="form--create">
		...
		<form @submit.prevent="criar" :class="{ hidden: fimForm }" ref="form">
			<section ref="desfile">
				...
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('endereco_concentracao') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('complemento_concentracao') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('cep_concentracao') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('bairro_concentracao') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					></textarea>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('itinerario') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('endereco_dispersao') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('complemento_dispersao') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					<a href="http://www.buscacep.correios.com.br/sistemas/buscacep/" target="_blank"><i class="icon-buscar icon"><span>buscar</span></i></a>
					<!-- consulta correios -> http://www.buscacep.correios.com.br/sistemas/buscacep/ -->
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('cep_dispersao') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('bairro_dispersao') }}</span>
				</fieldset>
				<!-- **************** NON ECXISTE: bairro_dispersao ************** -->
				...
				<fieldset>
					...
					/>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('data_do_desfile_2019') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('data_do_desfile_2020') }}</span>
				</fieldset>
				<!-- FIM Data (2020) -->
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('hr_concentracao') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('hr_desfile') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('hr_encerramento') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('subprefeitura') }}</span>
				</fieldset>
				<!-- FIM subprefeitura -->
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('publico_2019') }}</span>
				</fieldset>
				<!-- FIM publico_2019 -->
				...
				<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('publico_estimado') }}</span>
			...
			<section ref="contato">
				...
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('nome_responsavel') }}</span>
				</fieldset>
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('cpf_cnpj_responsavel') }}</span>
				</fieldset>
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('email_responsavel') }}</span>
				</fieldset>
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('telefone_responsavel') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('nome_coresponsavel') }}</span>
				</fieldset>
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('cpf_cnpj_coresponsavel') }}</span>
				</fieldset>
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('email_coresponsavel') }}</span>
				</fieldset>
				<fieldset>
					...
					>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('telefone_coresponsavel') }}</span>
				</fieldset>
			</section>
			<!-- FIM contato -->
			...
			<section ref="caracteristicas">
				...
				<fieldset>
					...
					/>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('ano_fundacao') }}</span>
				</fieldset>
				<!-- FIM ano_fundacao -->
			...
			<section ref="operacao">
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('n_brigadistas') }}</span>
				</fieldset>
				<!-- FIM n_brigadistas -->
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('n_ambulancias') }}</span>
				</fieldset>
				<!-- FIM n_ambulancias -->
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('n_cordeiros') }}</span>
				</fieldset>
				<!-- FIM n_cordeiros -->
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('n_segurancas_habilitados') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('n_banheiros_quimicos') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('n_catadores_de_residuos') }}</span>
				</fieldset>
				...
				<fieldset>
					...
					></textarea>
					<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('plano_de_operacao') }}</span>
				</fieldset>
			...
			<section ref="comunicacao">
				...
				></textarea>
				<span v-if="errors.first('nome_do_bloco')" class="errorPointer">{{ errors.first('resenha') }}</span>
				<!-- FIM resenha -->
		...
		<template v-if="fimForm">
			<div class="fim sucesso" v-if="!fetch.fazendo && fetch.sucesso">
				<h3 @click="salvaRespostas">Suas respostas foram enviadas!</h3>
...
export default {
	...
	methods: {
		...
		salvaRespostas () {
			...
			const jsonStr = JSON.stringify(this.desfile);
